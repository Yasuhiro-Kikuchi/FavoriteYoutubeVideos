...
Rails.application.config.assets.precompile += %w( videoconfigs.css )
Rails.application.config.assets.precompile += %w( videoconfigs.js )

Rails.application.config.assets.precompile += %w( videogenres.css )
Rails.application.config.assets.precompile += %w( videogenres.js )

Rails.application.config.assets.precompile += %w( videoposts.css )
Rails.application.config.assets.precompile += %w( videoposts.js)
